...
class _PosterCardState extends ConsumerState<PosterCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final rating = widget.item.rating ?? widget.item.media.rating ?? enrichedRating;
      ...
      child: DpadFocusable(
        ...
        child: GestureDetector(
          ...
          child: AnimatedScale(
            ...
            alignment: Alignment.center, // CSS default: transform-origin center center
            child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    if (url.isNotEmpty)
                      CachedNetworkImage(
                        imageUrl: url,
                        fit: BoxFit.cover,
                        placeholder: (_, _) => _Skeleton(radius: t.cardRadius),
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(Icons.star_rounded, size: ratingFs + 1, color: const Color(0xFFFBBF24)),
            ...
            SizedBox(
              width: imgW,
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: (w * 0.0016).clamp(2.0, 4.0)),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(
...
class _CollectionBtnState extends State<_CollectionBtn> {
  ...
  @override
  Widget build(BuildContext context) {
    final bgAlpha = widget.active ? null : (_hovered ? 204 : 153); // black/80 vs black/60
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: widget.active ? widget.activeBg : Colors.black.withAlpha(bgAlpha!),
            border: Border.all(
              color: widget.active ? widget.activeBorder : Colors.white.withAlpha(51),
              width: 1,
            ),
          ),
          child: Icon(
...
class _NoPoster extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Center(
      child: Text(
        'No Poster',
        style: TextStyle(color: const Color(0xFF8A8A8A), fontSize: t.fontSubtitle),
      ),
    ),
  );
}
